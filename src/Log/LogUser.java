...
public class LogUser extends JInternalFrame {

	private JTextField usernametext;
	private JPasswordField passwordtext;
	private static LogUser cframe = null;// 定义子窗体为私有
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try (Connection conn = dcu.getConnection(); // 获取数据库接
					...
					while (rs.next()) {
						...
						pass = rs.getString(2);
						if ((user.equals(usernametext.getText())) &&pass.equals(passwordtext.getText())&&userMsg.getText()!=""&&passMsg.getText()!="") {
//							flag = true;
